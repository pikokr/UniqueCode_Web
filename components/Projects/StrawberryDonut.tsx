        ...
        <div className='p-60 mx-auto ml-96 flex sm:gap-10'>
            ...
            <div className='block'>
                ...
                <div className='flex gap-4'>
                    ...
                    <button className='opacity-100 text-center text-white mt-5 transform hover:scale-110 motion-reduce:transform-none' style={{ width: '116px', height: '42px', background: '#FD8AA1 0% 0% no-repeat padding-box', borderRadius: '21px', boxShadow: '5px 5px 20px #4B4B4B29' }}>
